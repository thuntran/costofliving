...
For more examples on how to use the functions and data sets in this package, please refer to the [vignette](https://github.com/thuntran/costofliving/blob/main/vignettes/costofliving.Rmd).
